...
SECRET_KEY = config(
    'SECRET_KEY',
    default='django-insecure-fvar&+-@=(y$t3orr_mlyae=zl&##*dz-)#e9u5-gr*enal!p3',
)
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='pakwheels'),
        'USER': config('POSTGRES_USER', default='pakwheels'),
        'PASSWORD': config('POSTGRES_PASSWORD', default='pakwheels'),
